...
let current_users: string[] = [`SahirAhmed` , `HunaidSiddique` , `PeterParker` , `TomHoland` , `Johncena`]
let new_users: string[] = [`SaimAyub` , `Micheal` , `Junaidalam` , `Scarletwitch` , `SahirAhmed`]
