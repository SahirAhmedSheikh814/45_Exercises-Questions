/*
34. Pizzas: Think of at least three kinds of your favorite pizza. Store these pizza names in a array, and then use a for loop to print the
name of each pizza.
...
let favPizza: string[] = [`Pepperoni Pizza` , `BBQ Chicken Pizza` , `Cheese Pizza`]
...
Pizza tastes good at any time of the day. We've been eating pizza every Friday night for as long as I can remember. I really love Pizza!`);
