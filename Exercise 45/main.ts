/*
45. Cars: Write a function that stores information about a car in a Object. The function should always receive a manufacturer and a model
...
*/
 ...
 function carInformation (Manufacturer: String , Model: String, ...additionalInfo){
let car = {Manufacturer, Model, ...Object.fromEntries(additionalInfo)};
return car;
};

let mycarInformation = carInformation("BMW", "i8", ["Color" , "Black"], ["Year" , 2020]);
