...
var Album1 = make_album("ArijitSingh", "Tum Hi Ho");
var Album2 = make_album("ArmaanMalik", "Chale Aana");
var Album3 = make_album("AtifAslam", "Tere Sang Yara");
console.log(Album1);
console.log(Album2);
console.log(Album3);
...
var Album4 = make_album2("ArijitSingh", "Tum Hi Ho", 20);
var Album5 = make_album2("ArmaanMalik", "Chale Aana");
var Album6 = make_album2("AtifAslam", "Tere Sang Yara", 35);
console.log(Album4);
console.log(Album5);
console.log(Album6);
